...
import com.dropwizard.exceptions.StudentAlreadyRegisteredException;
...
public class StudentDAO implements StudentDAOInterface{
	...
	public Student getStudent(String userId){
		...
		try {
			...
			student.setRegistrationStatus(Boolean.valueOf(rs.getString("registrationStatus")));
	 ...
	 * @throws SQLException
	 */
	public void setRegistrationStatus(String studentId) throws StudentAlreadyRegisteredException, InvalidStudentException{
		logger.info("setRegistrationStatus()");
		String sql = "update student set registrationStatus=? where id=?";
		Student student=getStudent(studentId);
		if(student.getId()==null)
			throw new InvalidStudentException("Student "+studentId+" does not exist");
		System.out.println(student.isRegistered());
		if(student.isRegistrationStatus())
			throw new StudentAlreadyRegisteredException("Student "+studentId+" is already registered");
	 ...
	 */
	public void addCourse(String studentId,String courseId) throws SQLException, InvalidCourseException{
		...
		sql = "insert into studentcourse values(?,?,?)";
		PreparedStatement st;
		try {
			st = conn.prepareStatement(sql);
			String id=studentId;
	 ...
	 * @throws SQLException
	 */
	public void dropCourse(String studentId,String courseId) throws InvalidCourseException, SQLException{
	 ...
	 * @throws InvalidStudentException 
	 */
	public HashMap<String, Integer> getGrades(String studentId) throws SQLException, InvalidStudentException{
		...
		sql = "select * from studentcourse where studentId=?";
	 ...
	 * @throws InvalidStudentException 
	 */
	public HashMap<String,String> getAllEnrolledCourses(String studentId) throws SQLException, InvalidStudentException{
